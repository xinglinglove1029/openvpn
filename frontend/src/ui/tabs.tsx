...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-9 items-center justify-center overflow-x-auto whitespace-nowrap rounded-lg bg-muted p-1 text-muted-foreground sm:inline-flex sm:flex-wrap sm:overflow-visible sm:whitespace-nowrap",
      className
    )}
    {...props}
  />
